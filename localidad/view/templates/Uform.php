<!-- Formulario de modificacion de localidad-->
<center>
  <form method="post" action="<?php echo $formAction ?>" enctype="application/x-www-form-urlencoded">
    ...
    <div>
      ...
      <div>
        ...
        <div>
          <input onKeypress="if (event.keyCode < 48 || event.keyCode > 57)event.returnValue = false;" type="text" value="<?php echo ((isset($txtId)) ? $txtId : '') ?>" id="txtId" name="txtId" class="campo" placeholder="Insert ID" readonly="txtId" required min="10" max="15">
        </div>
      </div>
      <!--input de nombre-->
      <div>
