<!-- Formulario de registro de un programa-->
<center>
  <form method="post" action="<?php echo $formAction ?>" enctype="application/x-www-form-urlencoded">

    <!--Formulaario de registro de un programa -->
    <div>
      ...
      <div>
        ...
        <div>
          <input onKeypress="if (event.keyCode < 48 || event.keyCode > 57)
                event.returnValue = false;" type="text" value="<?php echo ((isset($idProg)) ? $idProg : '') ?>" id="idProg" name="idProg" class="campo" placeholder="Insert Codigo Del Programa" required min="10" max="20">
        </div>
      </div>
